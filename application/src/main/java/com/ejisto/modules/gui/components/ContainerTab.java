...
public class ContainerTab extends JSplitPane {
    ...
    private void init() {
        ...
        eventDispatcher.registerApplicationEventListener(ApplicationDeployed.class,
        ...
        eventDispatcher.registerApplicationEventListener(LogMessage.class,
    ...
    private JPanel getServerSummaryPane() {
        ...
        serverSummaryPane = new ServerSummary(containerId, serverName, eventDispatcher);
        return serverSummaryPane;
    }
    ...
    private LogViewer getLogViewer() {
        ...
        logViewer = new LogViewer(eventDispatcher);
        return logViewer;
    }
    ...
    private RegisteredContextList getContextList() {
        ...
        contextList = new RegisteredContextList(webApplicationRepository, eventDispatcher);
        return contextList;
    }
