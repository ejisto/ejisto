...
public enum StringConstants {
    ...
    CTX_GET_CUSTOM_OBJECT_FACTORY("/internal/getCustomObjectFactory"),
    CTX_GET_MOCKED_FIELD("/internal/getField"),
    CTX_GET_SETTINGS("/getSettings"),
    CTX_SESSION_RECORDER("/sessionRecorder"),
    DEFAULT_SERVLET_NAME("ejistoDefaultServlet"),
    DEV_MODE("ejisto.dev.mode"),
    CTX_NEWLY_CREATED_FIELDS("/internal/newlyCreatedFields"),
